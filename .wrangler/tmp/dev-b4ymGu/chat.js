...
var chatRoom = class {
  ...
  async fetch(request) {
    ...
    if (upgradeHeader !== "websocket") {
      const cursor2 = this.sql.exec("SELECT text FROM messages ORDER BY id ASC");
      const results = Array.from(cursor2);
...
// .wrangler/tmp/bundle-kjIYhx/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kjIYhx/middleware-loader.entry.ts
